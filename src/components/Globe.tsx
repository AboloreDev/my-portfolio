...
const GLOBE_CONFIG = {
  ...
  mapSamples: 16000,
  mapBrightness: 1.1,
  baseColor: [0.1, 0.12, 0.18], // Dark bluish-gray — visible on #030412
  dark: 0.4, // Adds subtle shadow/depth
  diffuse: 0.6, // Soft lighting across the globe
  markerColor: [1, 0.6, 0.2], // Warm orange/amber markers
  glowColor: [0.3, 0.8, 1], // Soft electric blue glow
  markers: [
